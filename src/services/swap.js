...
class SwapService {
  ...
  async getFeeData() {
    try {
      ...
      this.logger.warn(`⚠️ Error getting fee data: ${error.message}. Using default values.`, { walletIndex: this.walletIndex });
      return {
  ...
  async estimateGas(txParams) {
    try {
      ...
      this.logger.warn(`⚠️ Error estimating gas: ${error.message}. Using default values.`, { walletIndex: this.walletIndex });
        ...
        // If swapping from ERC20 token
          ...
          if (currentAllowance.lt(amountIn)) {
            ...
            try {
              ...
              this.logger.warn(`⚠️ Error estimating gas for approval: ${error.message}. Using default value.`, { walletIndex: this.walletIndex });
            }
