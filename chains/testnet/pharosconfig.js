const { JsonRpcProvider } = require('ethers');
    ...
    const rpcProviders = [
        new JsonRpcProvider('https://testnet.dplabs-internal.com', { name: 'pharos-testnet', chainId: 688688 }),
    ];
    ...
    const baseExplorerUrl = 'https://testnet.pharosscan.xyz';
    const explorer = {
        get tx() {
...
module.exports = { rotateRpcProvider, provider, explorer, ticker };
